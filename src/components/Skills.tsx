...
const skillGroups: SkillGroup[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Playwright", iconClass: "devicon-playwright-plain colored" },
      { name: "XGBoost", customIcon: <img src="/logos/xgboost.svg" className="w-[40px] h-[40px]" alt="XGBoost" /> },
      { name: "MLflow", customIcon: <img src="https://cdn.simpleicons.org/mlflow" className="w-[40px] h-[40px]" alt="MLflow" /> },
    ],
  },
];
